...
!function (t, e) {
    ...
    var a = function (a, i, s) {
        ...
        if ("object" == typeof i.ranges) {
            ...
            /* 2023.01.26 remove custom row twkim */
        ...
        "function" == typeof s && (this.callback = s), this.timePicker || (this.startDate = this.startDate.startOf("day"), this.endDate = this.endDate.endOf("day"), this.container.find(".calendar-time").hide()), this.timePicker && this.autoApply && (this.autoApply = !1), this.autoApply && this.container.addClass("auto-apply"), "object" == typeof i.ranges && this.container.addClass("show-ranges"), this.singleDatePicker && (this.container.addClass("single"), this.container.find(".drp-calendar.left").addClass("single"), this.container.find(".drp-calendar.left").show(), this.container.find(".drp-calendar.right").hide(), !this.timePicker && this.autoApply && this.container.addClass("auto-apply")),
        (void 0 === i.ranges && !this.singleDatePicker ||
            this.alwaysShowCalendars) && this.container.addClass("show-calendar"),
    ...
    return a.prototype = {
        constructor: a, setStartDate: function (e) {
            ...
            /*this.container.addClass("show-calendar"), */
                this.move(), this.element.trigger("showCalendar.daterangepicker", this)
            ...
            t && (this.showCustomRangeLabel ? this.chosenLabel = this.container.find(".ranges li:first").addClass("active").attr("data-range-key") : this.chosenLabel = null, this.showCalendars())
