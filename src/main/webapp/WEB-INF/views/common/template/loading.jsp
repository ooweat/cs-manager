...
<body>
	<div id="app">
		<div class="main-wrapper">
			...
			<div class='loading_layer' style="display: flex;align-items: center;justify-content: center;">
	...
	<script type="text/javascript" src="/assets/js/components-multiple-upload.js"></script>--%>
